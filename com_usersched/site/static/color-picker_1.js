...
var ColorPicker = new Class({
	...
	initialize: function(el,options){
		...
		this.el.addEvent('keyup', function(e){ e = new Event(e);  try{ this.colorPanel.setStyle(this.options.stylattr, this.el.value); } catch(e){}}.bind(this));
		...
		for (var i=0; i< colorArray.length; i++) {
			...
			for ( var j=0; j< colorArray.length; j++) {
				for ( var k=0; k< colorArray.length; k++) {
					...
					currCell.addEvent('mouseover', function(e, currColor){ e = new Event(e);  this.colorPanel.setStyle(this.options.stylattr, currColor);  this.infoPanel.innerHTML = currColor; }.bindWithEvent(this, currColor));
		...
		this.chartContainer.addEvent('mouseout', function(e, currColor){ e = new Event(e);  try{this.colorPanel.setStyle(this.options.stylattr, this.el.value); } catch(e){} this.infoPanel.innerHTML = ''; }.bindWithEvent(this, currColor));
