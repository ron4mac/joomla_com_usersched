...
if ($skin) {
	...
	//	$this->document->addStylesheet('components/com_usersched/scheduler/codebase/dhtmlxscheduler_'.$skin.'.css', $skinopts);
		$this->document->addStylesheet('https://cdn.dhtmlx.com/scheduler/edge/dhtmlxscheduler_'.$skin.'.css');
...
//	$this->document->addStylesheet('components/com_usersched/scheduler/codebase/dhtmlxscheduler.css', $skinopts);
	$this->document->addStylesheet('https://cdn.dhtmlx.com/scheduler/edge/dhtmlxscheduler.css');
}
...
if ($this->canCfg) {
	...
	$script .= 'USched.cfgURL = \'<img src="components/com_usersched/static/cfg16-4.png" title="Configure calendar" class="usched_act" alt="" onclick="window.location=\\\''.$cfgurl.'\\\'" />\';';
}
...
$this->document->addScript('https://cdn.dhtmlx.com/scheduler/edge/dhtmlxscheduler.js');
